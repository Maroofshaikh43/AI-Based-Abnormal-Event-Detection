...
# YOLO is scanning frmae by frame to get the results for the object detection
...
def video_detection(path_x):
    try:
        ...
        cloudinary.config(
            cloud_name='dohsb154b',
            api_key='434323153877657',
            api_secret='R9G2p7aidIDBvB3_zegHPrQdbHU'
        )
        ...
        while True:
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    # Check confidence against the threshold for the specific class
